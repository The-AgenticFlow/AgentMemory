...
pub use config::{
    AdaptiveConfig, BufferConfig, ConsolidationConfig, PatternConfig, PlasticityConfig,
    RetrievalConfig, RuntimeConfig, TaskRelevanceMode, ThalamusConfig, TuningProfile,
};
pub use engine::{
